...
traceSchedulerEventTestBlockWith setTickTime tracer0 tracer = \case
 ...
 where
  ...
  traceJumpingState = \case
    ...
    Objector initState goodJumpInfo badPoint ->
      unwords
        [ "Objector"
        , show initState
  ...
  traceJumperState = \case
    ...
    FoundIntersection initState goodJumpInfo point ->
      unwords
        [ "(FoundIntersection"
        , show initState
        , terseJumpInfo goodJumpInfo
...
traceDbjEventWith ::
  ...
  m ()
traceDbjEventWith tracer =
  traceWith tracer . \case
